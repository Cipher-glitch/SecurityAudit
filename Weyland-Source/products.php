...
<form method="GET">
  <div class="form-group">
    ...
    <select class="form-control" id="theSelect" name="theSelect">
      <option value="terra.html">Terraforming</option>
      <option value="cryo.html">Hypersleep Capsule</option>
    </select>
  </div>
...
<?php
  if (!isset($_GET["theSelect"])){
    echo ("<h4>Showing <b>all</b></h4>");
    include "includes/terra.html";
   }
    else{

  include "includes/".$_GET["theSelect"];
  }
?>
